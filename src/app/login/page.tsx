...
export default function Login() {
  return (
    <main className="min-h-screen w-full mt-3 p-4 flex flex-col items-center justify-center">
      <div className="min-w-full xsl:min-w-[60vh] p-6 xsl:px-14 xsl:py-14 bg-blue-700 rounded-2xl">
      ...
      <div className="fixed bottom-0 left-0 w-full py-10 text-black px-10 bg-white">
        <p className="text-xs px-5 mb-12">
